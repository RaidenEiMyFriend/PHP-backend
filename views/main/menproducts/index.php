            ...
            ?>
               ...
               <div id="card" class="col mb-3"  >
                  <div class="card h-100 rounded-2" >
                     <!-- Product image-->
                     <?php if ($menproduct->sale > 0) {?>
                        <div class="badge bg-warning text-dark position-absolute" style="top: 0.5rem; right: 0.5rem">SALE  <?php echo  $menproduct->sale; ?> %</div>
                     <?php }?> 
                     <img class="card-img-top" src="/Web/<?php echo $menproduct->img; ?>" style="height: 300px;" alt="..." />
                     <!-- Product details-->
                     <div class="card-body p-4">
                        <div class="text-center">
                           <!-- Product name-->
                           <h5 class="product-name fw-bolder"><?php echo $menproduct->name;?></h5>
                           <!-- Product price-->
                           <?php if ($menproduct->sale > 0) {?>
                              <span class="red"><?php echo number_format($menproduct->price*(100-$menproduct->sale)/100, 0, ',', '.'); ?> VNĐ</span></span> <span class="money-unit"></span> 
                              <span class="text-muted text-decoration-line-through"><?php echo number_format($menproduct->price, 0, ',', '.') ?> VNĐ</span>                      
                           <?php }
                              else {
                           ?> 
                              <span class=" "><?php echo number_format($menproduct->price, 0, ',', '.') ?> VNĐ</span>    
                           <?php }?>
                        </div>
                        <!-- Rating -->
                        <div class="text-center">
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                           <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="index.php?page=main&controller=detail&id=<?php  echo $menproduct->id;?>&action=index">Xem thêm</a></div>
                        </div>
